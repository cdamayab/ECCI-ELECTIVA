...
if opcion == 1:
    ...
    base_mayor = float(input("Ingrese la medida de la base mayor del cono truncado: "))
    base_menor = float(input("Ingrese la medida de la base menor del cono truncado: "))
...
print("El volumen del", solido, "es:", volumen)